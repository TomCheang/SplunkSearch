...
function New-SplunkSearch {
  ...
  .PARAMETER Credential
    Username does not include domain suffix (@fb.com).  Provide your unixname or
  ...
  Try {
    ...
    if (-not $Credential) {
      ...
      $splSplunkCred = @{
        ...
        Message = 'Enter Splunk creds.  (no @fb.com suffix)'
      }
...
function Suspend-CertificateValidationForSelfSignedSSL {
  ...
  Param(
    #serial of self-signed cert at fb.splunkcloud.com:8089
    $serial = '9398c83db612d1de154f26294483a24dab6e6ae9'
  )
